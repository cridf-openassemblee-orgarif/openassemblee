...
public class AutreMandatResource {
    ...
    @Timed
    public ResponseEntity<AutreMandat> createAutreMandat(
        @RequestBody AutreMandat autreMandat
        ...
        if (autreMandat.getId() != null) {
            return ResponseEntity
                ...
                .header(
                    "Failure",
                    "A new autreMandat cannot already have an ID"
                )
                .body(null);
        }
        ...
        return ResponseEntity
            .created(new URI("/api/autreMandats/" + result.getId()))
            .headers(
    ...
    @Timed
    public ResponseEntity<AutreMandat> updateAutreMandat(
        @RequestBody AutreMandat autreMandat
    ) throws URISyntaxException {
    ...
    public List<AutreMandat> getAllAutreMandats() {
        ...
        return autreMandatRepository.findByMandature(
    ...
    public ResponseEntity<AutreMandat> getAutreMandat(@PathVariable Long id) {
        ...
        return Optional
            .ofNullable(autreMandatRepository.findOne(id))
            .map(autreMandat -> new ResponseEntity<>(autreMandat, HttpStatus.OK)
            )
     ...
     */
    @RequestMapping(
        value = "/_search/autreMandats/{query}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
