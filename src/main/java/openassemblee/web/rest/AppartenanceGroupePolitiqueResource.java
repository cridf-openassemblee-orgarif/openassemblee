...
public class AppartenanceGroupePolitiqueResource {
    ...
    private final Logger log = LoggerFactory.getLogger(
        AppartenanceGroupePolitiqueResource.class
    );
     ...
     */
    @RequestMapping(
        value = "/appartenanceGroupePolitiques",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<AppartenanceGroupePolitique> createAppartenanceGroupePolitique(
        @RequestBody AppartenanceGroupePolitique appartenanceGroupePolitique
    ) throws URISyntaxException {
        log.debug(
            "REST request to save AppartenanceGroupePolitique : {}",
        ...
        if (appartenanceGroupePolitique.getId() != null) {
            return ResponseEntity
                ...
                .header(
                    "Failure",
                    "A new appartenanceGroupePolitique cannot already have an ID"
                )
                .body(null);
        }
        AppartenanceGroupePolitique result =
            appartenanceGroupePolitiqueRepository.save(
                appartenanceGroupePolitique
            );
        ...
        return ResponseEntity
            .created(
                new URI("/api/appartenanceGroupePolitiques/" + result.getId())
            )
            .headers(
    ...
    @Timed
    public ResponseEntity<AppartenanceGroupePolitique> updateAppartenanceGroupePolitique(
        @RequestBody AppartenanceGroupePolitique appartenanceGroupePolitique
    ) throws URISyntaxException {
        log.debug(
            "REST request to update AppartenanceGroupePolitique : {}",
            appartenanceGroupePolitique
        );
        if (appartenanceGroupePolitique.getId() == null) {
            return createAppartenanceGroupePolitique(
                appartenanceGroupePolitique
            );
        }
        AppartenanceGroupePolitique result =
        ...
        appartenanceGroupePolitiqueSearchRepository.save(
            appartenanceGroupePolitique
        );
        ...
        return ResponseEntity
            ...
            .headers(
                HeaderUtil.createEntityUpdateAlert(
                    "appartenanceGroupePolitique",
                    appartenanceGroupePolitique.getId().toString()
                )
            )
            .body(result);
    }
     ...
     */
    @RequestMapping(
        value = "/appartenanceGroupePolitiques/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<AppartenanceGroupePolitique> getAppartenanceGroupePolitique(
        @PathVariable Long id
    ) {
        log.debug("REST request to get AppartenanceGroupePolitique : {}", id);
        return Optional
            .ofNullable(appartenanceGroupePolitiqueRepository.findOne(id))
            .map(appartenanceGroupePolitique ->
                new ResponseEntity<>(appartenanceGroupePolitique, HttpStatus.OK)
            )
    ...
    @Timed
    public ResponseEntity<Void> deleteAppartenanceGroupePolitique(
        @PathVariable Long id
    ) {
        log.debug(
            "REST request to delete AppartenanceGroupePolitique : {}",
            id
        );
     ...
     */
    @RequestMapping(
        value = "/_search/appartenanceGroupePolitiques/{query}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public List<AppartenanceGroupePolitique> searchAppartenanceGroupePolitiques(
        @PathVariable String query
    ) {
        return StreamSupport
            .stream(
                appartenanceGroupePolitiqueSearchRepository
