...
public class FonctionCommissionThematiqueResource {
    ...
    private final Logger log = LoggerFactory.getLogger(
        FonctionCommissionThematiqueResource.class
    );
     ...
     */
    @RequestMapping(
        value = "/fonctionCommissionThematiques",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<FonctionCommissionThematique> createFonctionCommissionThematique(
        @RequestBody FonctionCommissionThematique fonctionCommissionThematique
    ) throws URISyntaxException {
        log.debug(
            "REST request to save FonctionCommissionThematique : {}",
        ...
        if (fonctionCommissionThematique.getId() != null) {
            return ResponseEntity
                ...
                .header(
                    "Failure",
                    "A new fonctionCommissionThematique cannot already have an ID"
                )
                .body(null);
        }
        FonctionCommissionThematique result =
            fonctionCommissionThematiqueRepository.save(
                fonctionCommissionThematique
            );
        ...
        return ResponseEntity
            .created(
                new URI("/api/fonctionCommissionThematiques/" + result.getId())
            )
            .headers(
    ...
    @Timed
    public ResponseEntity<FonctionCommissionThematique> updateFonctionCommissionThematique(
        @RequestBody FonctionCommissionThematique fonctionCommissionThematique
    ) throws URISyntaxException {
        log.debug(
            "REST request to update FonctionCommissionThematique : {}",
            fonctionCommissionThematique
        );
        if (fonctionCommissionThematique.getId() == null) {
            return createFonctionCommissionThematique(
                fonctionCommissionThematique
            );
        }
        FonctionCommissionThematique result =
        ...
        fonctionCommissionThematiqueSearchRepository.save(
            fonctionCommissionThematique
        );
        ...
        return ResponseEntity
            ...
            .headers(
                HeaderUtil.createEntityUpdateAlert(
                    "fonctionCommissionThematique",
                    fonctionCommissionThematique.getId().toString()
                )
            )
            .body(result);
    }
     ...
     */
    @RequestMapping(
        value = "/fonctionCommissionThematiques/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<FonctionCommissionThematique> getFonctionCommissionThematique(
        @PathVariable Long id
    ) {
        log.debug("REST request to get FonctionCommissionThematique : {}", id);
        return Optional
            .ofNullable(fonctionCommissionThematiqueRepository.findOne(id))
            .map(fonctionCommissionThematique ->
                new ResponseEntity<>(
                    fonctionCommissionThematique,
                    HttpStatus.OK
                )
    ...
    @Timed
    public ResponseEntity<Void> deleteFonctionCommissionThematique(
        @PathVariable Long id
    ) {
        log.debug(
            "REST request to delete FonctionCommissionThematique : {}",
            id
        );
     ...
     */
    @RequestMapping(
        value = "/_search/fonctionCommissionThematiques/{query}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public List<FonctionCommissionThematique> searchFonctionCommissionThematiques(
        @PathVariable String query
    ) {
        return StreamSupport
            .stream(
                fonctionCommissionThematiqueSearchRepository
