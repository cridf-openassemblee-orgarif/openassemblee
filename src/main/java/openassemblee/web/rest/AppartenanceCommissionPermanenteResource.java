...
public class AppartenanceCommissionPermanenteResource {
    ...
    private final Logger log = LoggerFactory.getLogger(
        AppartenanceCommissionPermanenteResource.class
    );
     ...
     */
    @RequestMapping(
        value = "/appartenanceCommissionPermanentes",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<AppartenanceCommissionPermanente> createAppartenanceCommissionPermanente(
        @RequestBody AppartenanceCommissionPermanente appartenanceCommissionPermanente
    ) throws URISyntaxException {
        log.debug(
            "REST request to save AppartenanceCommissionPermanente : {}",
        ...
        if (appartenanceCommissionPermanente.getId() != null) {
            return ResponseEntity
                ...
                .header(
                    "Failure",
                    "A new appartenanceCommissionPermanente cannot already have an ID"
                )
                .body(null);
        }
        AppartenanceCommissionPermanente result =
            appartenanceCommissionPermanenteRepository.save(
                appartenanceCommissionPermanente
            );
        ...
        return ResponseEntity
            .created(
                new URI(
                    "/api/appartenanceCommissionPermanentes/" + result.getId()
                )
            )
            .headers(
    ...
    @Timed
    public ResponseEntity<AppartenanceCommissionPermanente> updateAppartenanceCommissionPermanente(
        @RequestBody AppartenanceCommissionPermanente appartenanceCommissionPermanente
    ) throws URISyntaxException {
        log.debug(
            "REST request to update AppartenanceCommissionPermanente : {}",
            appartenanceCommissionPermanente
        );
        if (appartenanceCommissionPermanente.getId() == null) {
            return createAppartenanceCommissionPermanente(
                appartenanceCommissionPermanente
            );
        }
        AppartenanceCommissionPermanente result =
        ...
        appartenanceCommissionPermanenteSearchRepository.save(
            appartenanceCommissionPermanente
        );
        ...
        return ResponseEntity
            ...
            .headers(
                HeaderUtil.createEntityUpdateAlert(
                    "appartenanceCommissionPermanente",
                    appartenanceCommissionPermanente.getId().toString()
                )
            )
            .body(result);
    }
    ...
    public List<AppartenanceCommissionPermanente> getAllAppartenanceCommissionPermanentes() {
        ...
        return appartenanceCommissionPermanenteRepository.findByMandature(
     ...
     */
    @RequestMapping(
        value = "/appartenanceCommissionPermanentes/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public ResponseEntity<AppartenanceCommissionPermanente> getAppartenanceCommissionPermanente(
        @PathVariable Long id
    ) {
        log.debug(
            "REST request to get AppartenanceCommissionPermanente : {}",
            id
        );
    ...
    @Timed
    public ResponseEntity<Void> deleteAppartenanceCommissionPermanente(
        @PathVariable Long id
    ) {
        log.debug(
            "REST request to delete AppartenanceCommissionPermanente : {}",
            id
        );
        ...
        auditTrailService.logDeletion(
            AppartenanceCommissionPermanente.class,
            id
        );
        return ResponseEntity
            .ok()
     ...
     */
    @RequestMapping(
        value = "/_search/appartenanceCommissionPermanentes/{query}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE
    )
    @Timed
    public List<AppartenanceCommissionPermanente> searchAppartenanceCommissionPermanentes(
        @PathVariable String query
    ) {
        return Lists.newArrayList(
            appartenanceCommissionPermanenteSearchRepository.search(
