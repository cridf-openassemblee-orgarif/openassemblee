...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    public void init() {
        ...
        metricRegistry.register(
            PROP_METRIC_REG_JVM_THREADS,
            new ThreadStatesGaugeSet()
        );
        metricRegistry.register(
            PROP_METRIC_REG_JVM_FILES,
    ...
    public static class GraphiteRegistry {
        ...
        private void init() {
            if (jHipsterProperties.getMetrics().getGraphite().isEnabled()) {
                ...
                String graphiteHost = jHipsterProperties
                    .getMetrics()
                    .getGraphite()
                    .getHost();
                Integer graphitePort = jHipsterProperties
                    .getMetrics()
                    .getGraphite()
                    .getPort();
                String graphitePrefix = jHipsterProperties
                    .getMetrics()
                    .getGraphite()
                    .getPrefix();
    ...
    public static class SparkRegistry {
        ...
        private void init() {
            if (jHipsterProperties.getMetrics().getSpark().isEnabled()) {
                ...
                String sparkHost = jHipsterProperties
                    .getMetrics()
                    .getSpark()
                    .getHost();
                Integer sparkPort = jHipsterProperties
                    .getMetrics()
                    .getSpark()
                    .getPort();
