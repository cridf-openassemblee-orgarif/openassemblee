    ...
    $stateProvider
        .state("reunionCao", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/reunionCao/reunionCaos.html",
        ...
        .state("reunionCao.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/reunionCao/reunionCao-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "ReunionCao",
                    function ($stateParams, ReunionCao) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/reunionCao/reunionCao-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/reunionCao/reunionCao-delete-dialog.html",
