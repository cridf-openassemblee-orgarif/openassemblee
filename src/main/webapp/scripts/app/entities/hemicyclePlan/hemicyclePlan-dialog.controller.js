...
angular.module("openassembleeApp").controller("HemicyclePlanDialogController", [
    ...
    function (
        ...
        HemicycleConfiguration.query(function (result) {
            ...
            $scope.hemicyclePlan.configuration =
                $scope.hemicycleConfigurations[0];
        });
        ...
        $scope.save = function () {
            ...
            if ($scope.hemicyclePlan.id == null) {
                ...
                if ($scope.properties.fromAlphabeticOrder) {
                    ...
                    hemicyclePlanCreationDTO.fromSeanceId =
                        $scope.properties.fromSeance.id;
                } else if ($scope.properties.fromProjet) {
                    hemicyclePlanCreationDTO.fromProjetId =
                        $scope.properties.fromProjet.id;
                }
                HemicyclePlan.save(
