    ...
    $stateProvider
        .state("hemicyclePlan", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/hemicyclePlan/hemicyclePlans.html",
        ...
        .state("hemicyclePlan.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/hemicyclePlan/hemicyclePlan-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "HemicyclePlan",
                    function ($stateParams, HemicyclePlan) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/hemicyclePlan/hemicyclePlan-dialog.html",
                    ...
                    $modal
                        .open({
                            ...
                            resolve: {
                                entity: [
                                    "HemicyclePlan",
                                    function (HemicyclePlan) {
                                        return HemicyclePlan.get({
                                            id: $stateParams.id,
                                        });
                                    },
                                ],
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/hemicyclePlan/hemicyclePlan-delete-dialog.html",
