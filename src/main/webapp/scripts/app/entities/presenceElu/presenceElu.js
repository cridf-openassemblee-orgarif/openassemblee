    ...
    $stateProvider
        .state("presenceElu", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/presenceElu/presenceElus.html",
        ...
        .state("presenceElu.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/presenceElu/presenceElu-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "PresenceElu",
                    function ($stateParams, PresenceElu) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/presenceElu/presenceElu-dialog.html",
                    ...
                    $modal
                        .open({
                            ...
                            resolve: {
                                entity: [
                                    "PresenceElu",
                                    function (PresenceElu) {
                                        return PresenceElu.get({
                                            id: $stateParams.id,
                                        });
                                    },
                                ],
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/presenceElu/presenceElu-delete-dialog.html",
