    ...
    $stateProvider
        .state("commissionThematique", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/commissionThematique/commissionThematiques.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/commissionThematique/commissionThematique-dialog.html",
        ...
        .state("commissionThematique.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/commissionThematique/commissionThematique-detail.html",
            ...
            resolve: {
                entity: [
                    ...
                    function ($stateParams, CommissionThematique) {
                        return CommissionThematique.get({
                            id: $stateParams.id,
                        });
                    },
                ],
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/commissionThematique/commissionThematique-delete-dialog.html",
                        ...
                        .result.then(
                            function (result) {
                                $state.go("commissionThematique", null, {
                                    reload: true,
                                });
                            },
                            function () {
