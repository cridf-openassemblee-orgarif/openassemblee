    ...
    $stateProvider
        ...
        .state("seance.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/seance/seance-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "Seance",
                    function ($stateParams, Seance) {
                        return Seance.getDto({ id: $stateParams.id });
                    },
                ],
            },
        })
        .state("seance.hemicycle", {
            parent: "seance.detail",
            url: "/hemicycle/{hemicyclePlanId}",
            data: {
                authorities: ["ROLE_USER"],
                pageTitle: "Seance",
            },
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/seance/seance-hemicycle.html",
                    controller: "SeanceHemicycleController",
                },
            },
        })
        .state("seance.hemicycleArchive", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/seance/seance-hemicycle-archive.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/seance/seance-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/seance/seance-delete-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/pouvoir/pouvoir-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/pouvoir/pouvoir-fermer-tous-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/pouvoir/pouvoir-delete-dialog.html",
