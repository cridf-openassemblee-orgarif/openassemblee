    ...
    $stateProvider
        .state("groupesPolitiques", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/groupePolitique/groupePolitique.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/groupePolitique/groupePolitique-dialog.html",
                        ...
                        .result.then(
                            function (result) {
                                $state.go("groupesPolitiques.detail", {
                                    id: result.id,
                                });
                            },
                            function () {
        ...
        .state("groupesPolitiques.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/groupePolitique/groupePolitique-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "GroupePolitique",
                    function ($stateParams, GroupePolitique) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/groupePolitique/groupePolitique-edit-dialog.html",
                            controller: "GroupePolitiqueEditDialogController",
                            size: "lg",
                            resolve: {
                                entity: [
                                    "GroupePolitique",
                                    function (GroupePolitique) {
                                        return GroupePolitique.get({
                                            id: $stateParams.id,
                                        });
                                    },
                                ],
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/groupePolitique/groupePolitique-delete-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/groupePolitique/upload-image-dialog.html",
                            controller:
                                "UploadImageGroupePolitiqueDialogController",
                            size: "lg",
                        })
                        .result.then(
                            function (result) {
