    ...
    .controller("AppartenanceGroupePolitiqueDialogController", [
        ...
        function (
            ...
            var onSaveSuccess = function (result) {
                $scope.$emit(
                    "openassembleeApp:appartenanceGroupePolitiqueUpdate",
                    result
                );
            ...
            $scope.save = function () {
                $scope.isSaving = true;
                $scope.appartenanceGroupePolitique.elu = {
                    id: $stateParams.id,
                };
                if ($scope.appartenanceGroupePolitique.id != null) {
                    AppartenanceGroupePolitique.update(
                        $scope.appartenanceGroupePolitique,
                        onSaveSuccess,
                        onSaveError
                    );
                } else {
                    AppartenanceGroupePolitique.save(
                        $scope.appartenanceGroupePolitique,
                        onSaveSuccess,
                        onSaveError
                    );
