    ...
    $stateProvider
        .state("distinctionHonorifique", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/distinctionHonorifique/distinctionHonorifiques.html",
        ...
        .state("distinctionHonorifique.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/distinctionHonorifique/distinctionHonorifique-detail.html",
            ...
            resolve: {
                entity: [
                    ...
                    function ($stateParams, DistinctionHonorifique) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        ...
                        .result.then(
                            function (result) {
                                $state.go("distinctionHonorifique", null, {
                                    reload: true,
                                });
                            },
                            function () {
