    ...
    .controller(
        ...
        function ($scope, $rootScope, $stateParams, entity) {
            ...
            var updateScope = function () {
                $scope.eluEnCommissionPermanente = check(
                    "appartenancesCommissionPermanente"
                );
                $scope.eluEnCommissionPermanenteOuFonction = check(
                    "appartenancesCommissionPermanente"
                );
                $scope.eluAGroupePolitique = check(
                    "appartenancesGroupePolitique"
                );
                $scope.eluAGroupePolitiqueOuFonction = check(
                    "appartenancesGroupePolitique",
                    "fonctionsGroupePolitique"
                );
                $scope.eluACommissionThematiqueOuFonction = check(
                ...
                angular.forEach(
                    $scope.dto.elu.appartenancesGroupePolitique,
                    function (a) {
                        if (a.dateFin == null) {
