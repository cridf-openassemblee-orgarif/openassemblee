    ...
    .controller("FonctionCommissionThematiqueDialogController", [
        ...
        function (
            ...
            var onSaveSuccess = function (result) {
                $scope.$emit(
                    "openassembleeApp:fonctionCommissionThematiqueUpdate",
                    result
                );
            ...
            $scope.save = function () {
                $scope.isSaving = true;
                $scope.fonctionCommissionThematique.elu = {
                    id: $stateParams.id,
                };
                if ($scope.fonctionCommissionThematique.id != null) {
                    FonctionCommissionThematique.update(
                        $scope.fonctionCommissionThematique,
                        onSaveSuccess,
                        onSaveError
                    );
                } else {
                    FonctionCommissionThematique.save(
                        $scope.fonctionCommissionThematique,
                        onSaveSuccess,
                        onSaveError
                    );
