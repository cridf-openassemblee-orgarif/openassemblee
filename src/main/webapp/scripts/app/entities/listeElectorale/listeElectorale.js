    ...
    $stateProvider
        .state("listeElectorale", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/listeElectorale/listeElectorales.html",
        ...
        .state("listeElectorale.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/listeElectorale/listeElectorale-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "ListeElectorale",
                    function ($stateParams, ListeElectorale) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/listeElectorale/listeElectorale-dialog.html",
                    ...
                    $modal
                        .open({
                            ...
                            resolve: {
                                entity: [
                                    "ListeElectorale",
                                    function (ListeElectorale) {
                                        return ListeElectorale.get({
                                            id: $stateParams.id,
                                        });
                                    },
                                ],
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/listeElectorale/listeElectorale-delete-dialog.html",
