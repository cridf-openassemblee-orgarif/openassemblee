    ...
    $stateProvider
        .state("autreMandat", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/autreMandat/autreMandats.html",
        ...
        .state("autreMandat.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/autreMandat/autreMandat-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "AutreMandat",
                    function ($stateParams, AutreMandat) {
