    ...
    $stateProvider
        .state("organisme", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/organisme/organismes.html",
        ...
        .state("organisme.detail", {
            ...
            views: {
                "content@": {
                    templateUrl:
                        "scripts/app/entities/organisme/organisme-detail.html",
            ...
            resolve: {
                entity: [
                    "$stateParams",
                    "Organisme",
                    function ($stateParams, Organisme) {
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/organisme/organisme-dialog.html",
            ...
            onEnter: [
                ...
                function ($stateParams, $state, $modal) {
                    $modal
                        .open({
                            templateUrl:
                                "scripts/app/entities/organisme/organisme-delete-dialog.html",
