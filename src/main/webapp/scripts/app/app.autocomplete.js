var finsDeMandat = [
    ...
    "Démission Président CRIF",
];
var finsGroupePolitique = [
    "Modification groupe",
...
var fonctionsElu = [
    "Président du groupe",
    "Président de commission thématique",
    "Vice-Président de commission thématique",
    "Secrétaire de commission thématique",
];
...
var statutsAppartenanceOrganisme = [
    "Titulaire",
    "Suppléant",
    "Suppléante",
    "Membre de droit",
...
var professions = [
    ...
    "Agent de sécurité",
    "Agent de voyages",
    "Agent des Douanes, Impôts, Trésor Public",
    ...
    "Assistant de chargé d'affaires",
    "Assistant de conservation",
    "Assistant de direction",
    "Assistant de gestion",
    "Assistant de gestion PMI/PME",
    ...
    "Chaudronnier",
    "Chauffagiste",
    "Chauffeur de car ou de bus",
    "Chauffeur de grande remise",
    "Chauffeur de maître",
    "Chauffeur de petite remise",
    "Chauffeur de poids lourds",
    "Chauffeur de taxi",
    "Chauffeur de transports en commun",
    "Chauffeur livreur",
    "Chauffeur routier",
    "Chef comptable",
    "Chef d'agence",
    ...
    "Choriste",
    "Chorégraphe",
    "Chroniqueur télé/radio",
    "Clerc de notaire / huissier",
    "Climaticien",
    "Coach sportif",
    "Coffreur boiseur",
    "Cogniticien",
    ...
    "Confiseur",
    "Conférencier",
    "Conseil en Assistance Maitrise d'ouvrage",
    "Conseiller",
    "Conseiller d'insertion, d'orientation et d'éducation",
    ...
    "Contrôleur des impôts, Trésor Public",
    ...
    "Directeur de bar",
    "Directeur de centre de vacances et loisirs",
    "Directeur de centre pénitentiaire",
    "Directeur de centre équestre",
    "Directeur de chaine de télévision",
    ...
    "Employé de bar/restaurant",
    "Employé de bureau",
    "Employé de commerce",
    "Employé de la fonction publique",
    "Employé de maison",
    "Employé de parc d'attractions/ salles de jeux",
    "Employé de restauration rapide",
    "En invalidité",
    "Encadreur",
    "Endocrinologue",
    "Enduiseur",
    "Enquêteur (sondage d'opinion)",
    "Enseignant",
    "Enseignant Chercheur",
    "Ensemblier électronique",
    ...
    "Exploitant agricole",
    "Fabricant de jouets",
    "Fabricants d'instruments/objets",
    "Facteur",
    "Famille d'accueil",
    "Façadier",
    "Femme au foyer",
    ...
    "Gardien d'immeuble",
    "Gardien de la paix",
    "Gardien de parcs et jardins",
    "Gardien de police municipale",
    "Gardien de zoo",
    "Garçon d'écurie",
    "Garçon de café/restaurant",
    "Gendarme",
    "Gestionnaire",
    ...
    "Greffier",
    "Groom",
    "Grossiste en biens de consommation",
    "Grutier",
    "Guichetier",
    ...
    "Gérant de salles de jeux/loisirs",
    ...
    "Intégrateur de contenus multimédias",
    "Intégrateur web",
    "Intérimaire",
    ...
    "Manipulateur de radiologie médicale",
    "Mannequin",
    "Manoeuvre bâtiment",
    "Manutentionnaire",
    "Maquettiste",
    ...
    "Monteur installateur d'équipements",
    "Monteur électricien réseau edf",
    "Mouleur en fonderie sur modèles",
    "Mouleur noyauteur",
    "Mouliste",
    "Musicien",
    "Musicien classique",
    ...
    "Personnel naviguant de compagnie aérienne",
    ...
    "Pilote de port",
    "Pilote de système de production",
    "Pilote fluvial",
    ...
    "Professeur d'activités sportives",
    ...
    "Responsable d'agence en assurance",
    "Responsable d'atelier",
    "Responsable d'exploitation",
    "Responsable d'un système d'information",
    ...
    "Réflexologue",
    "Régisseur des spectacles",
    "Régisseur général",
    "Régleur",
    "Régulateur de trafic",
    "Réparateur",
    "Répartiteur de dépôt",
    "Rééducateur",
    "Sage femme",
    "Sage femme homme",
    "Salarié agricole",
    ...
    "Steward",
    "Story-boarder",
    "Stratifieur en plastiques et composites",
    "Styliste",
    "Sténographe",
    "Sténotypiste",
    ...
    "Technicien de surface/d'entretien",
    "Technicien de vente",
    ...
    "Technicien méthode dans l'aéronautique",
